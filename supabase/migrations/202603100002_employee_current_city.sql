-- Add current_city column to employees for remote location tracking
ALTER TABLE app.employees
  ADD COLUMN IF NOT EXISTS current_city text;

-- Update update_my_profile RPC to accept current_city parameter
...
DROP FUNCTION IF EXISTS app.update_my_profile(text, text, app.employment_type, numeric, date);
GRANT EXECUTE ON FUNCTION app.update_my_profile(text, text, app.employment_type, numeric, date, text) TO authenticated;
